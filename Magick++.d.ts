...
export  class Image {
  ...
  fontTypeMetrics(text_: string): Magick.TypeMetric;

  fontTypeMetricsAsync(text_: string): Promise<Magick.TypeMetric>;

  fontTypeMetricsMultiline(text_: string): Magick.TypeMetric;

  fontTypeMetricsMultilineAsync(text_: string): Promise<Magick.TypeMetric>;
