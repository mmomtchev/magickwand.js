...
Napi::Value exports_MagickLibAddendum_get(const Napi::CallbackInfo &info) {
  ...
  try {
    ...
    jsresult = SWIG_FromCharPtr((const char *)"-21 (Beta)");
...
Napi::Value exports_MagickGitRevision_get(const Napi::CallbackInfo &info) {
  ...
  try {
    ...
    jsresult = SWIG_FromCharPtr((const char *)"98bb1d414:20231008");
...
Napi::Value exports_MagickReleaseDate_get(const Napi::CallbackInfo &info) {
  ...
  try {
    ...
    jsresult = SWIG_FromCharPtr((const char *)"2023-10-08");
...
Napi::Value exports_MagickVersion_get(const Napi::CallbackInfo &info) {
  ...
  try {
    ...
    jsresult = SWIG_FromCharPtr((const char *)"ImageMagick 7.1.1-21 (Beta) Q16-HDRI x86_64 98bb1d414:20231008 https://imagemagick.org");
