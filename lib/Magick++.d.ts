...
export function appendImages(first_: any, stack_: any): Magick.Image;

export function appendImagesAsync(first_: any, stack_: any): Promise<Magick.Image>;
...
export function forwardFourierTransformImage(image_: Magick.Image, magnitude_: any): Magick.Image[];

export function forwardFourierTransformImageAsync(image_: Magick.Image, magnitude_: any): Promise<Magick.Image[]>;
